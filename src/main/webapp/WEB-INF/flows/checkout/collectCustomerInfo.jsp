...
<div class="form-group">
<label class="control-label col-lg-2 col-lg-2" for="name" />Nazwa klienta</label>
<div class="col-lg-10">
...
<div class="form-group">
<label class="control-label col-lg-2 col-lg-2" for="phoneNumber" />Numer telefonu</label>
<div class="col-lg-10">
...
<input type="submit" id="btnAdd" class="btn btnprimary" value="Utwórz" name="_eventId_customerInfoCollected" />
