...
<div class="row">
<div class="col-md-5">
<img src="<c:url value="/resource/images/${product.productId}.png"></c:url>" style="width:100%"/>
</div>
<div class="col-md-5">
<h3>${product.name}</h3>
<p>${product.description}</p>
<p>
<strong><spring:message code="product.code"/> </strong><span class="label label-warning">${product.productId}</span>
</p>
<p>
...
<p>
<strong><spring:message code="product.unitsInStock"/></strong>:${product.unitsInStock}
</p>
...
<p ng-controller="cartCtrl"><a href="#" class="btn btn-warning btn-large" ng-click="addToCart('${product.productId}')"><span class="glyphicon-shopping-cart glyphicon"></span><spring:message code="product.orderNow"/></a></p>
